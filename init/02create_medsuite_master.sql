...
GRANT SELECT, INSERT, UPDATE ON ALL ON ALL TABLES IN SCHEMA records TO gpapplication;
GRANT SELECT, INSERT, UPDATE ON ALL TABLES IN SCHEMA accounts TO gpapplication;
GRANT SELECT, INSERT, UPDATE ON ALL ON ALL TABLES IN SCHEMA gp TO gpapplication;
GRANT SELECT ON ALL TABLES IN SCHEMA patients TO gpapplication;
GRANT INSERT ON ALL TABLES IN SCHEMA admin TO gpapplication;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA patients TO gpapplication;


-- Extra Sequence checks

GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA admin TO medadmin, userapplication, gpapplication;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA accounts TO medadmin, userapplication, gpapplication;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA patients TO medadmin, userapplication, gpapplication;
